...
function init(){
    ...
    var vector_style_select = new OpenLayers.Style({'fillColor':'#cdcdcd','fillOpaciy':.9,
        'fontColor':'#232323','strokeColor':'#ffffff'});
...
function refresh(){
    var URL = document.getElementById("kmlSourceUrl").value  ;
    var tagname = document.getElementById("kmlTag").value  ;
    vector_layer.protocol.options.params['tags'] = tagname;
    vector_layer.protocol.options.url = URL;
